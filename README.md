...
> 自动监控 iOS 固件更新，发现新版本（例如 iOS 18.7、18.6 等低于 26.0 的固件）后，通过 Telegram Bot 自动推送通知。
...
| 名称 | 示例值 | 说明 |
|------|---------|------|
| `TELEGRAM_BOT_TOKEN` | `123456789:AAExampleToken` | Telegram BotFather 提供的 Token |
| `TELEGRAM_CHAT_ID` | `987654321` | 你在 @userinfobot 中获取的 ID |
